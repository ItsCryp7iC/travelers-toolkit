...
export default function AppLayout() {
 ...
 <div>
 <h1 className=" text-xl leading-tight text-[var(--text)]">
 Traveler's
 </h1>
 ...
 <p className="px-5 mb-2 text-xs text-[var(--muted)] tracking-widest uppercase">
 Navigation
 </p>
 {navItems.map((item) => {
 ...
 <p className="px-5 mb-2 text-xs text-primary/60 tracking-widest uppercase">
 Dev Tools
 </p>
 {devItems.map((item) => (
 <NavLink
 ...
 <p className="text-xs text-[var(--muted)] tracking-widest uppercase mb-1">
 My Roster
 </p>
