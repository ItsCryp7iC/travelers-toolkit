                    ...
                    {filtered.map((wp, idx) => {
                      ...
                      return (
                        ...
                        >
                            ...
                            <td className="px-4 py-2 text-center text-xs text-[var(--muted)] sticky left-[40px] z-10 bg-inherit border-r border-[var(--border)] w-[48px] min-w-[48px] max-w-[48px]">{idx + 1}</td>
